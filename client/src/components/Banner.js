...
export default function Banner() {
  ...
  return (
    <motion.section
     ...
     className='lg:py-32' id="home">
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        <div className='col-span-8 place-self-center text-center sm:text-left justify-self-start' style={{opacity: "1",transform: "none"}}>
        ...
        <div>
          ...
          <div className="col-span-4 place-self-center mt-4 lg:mt-0" style={{opacity: "1", transform: 'none'}}>
